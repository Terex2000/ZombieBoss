...
void EnemyController::createBoss(float x, float y, float health, float attack, float speed, int coins) {
    enemies.push_back(factory.createBoss(x, y, health, attack, speed, coins, textureManager.getTexture("zombie")));
}
